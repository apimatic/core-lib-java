...
public class CoreConfig {
	...
	private CoreConfig(CompatibilityFactory compatibilityFactory, String userAgent,
			...
			HttpClient httpClient, HttpHeaders globalhHeaders,
    ...
    /**
     * Builds a new {@link CoreConfig.Builder} object.
     * Creates the instance with the state of the current state.
     * @return a new {@link CoreConfig.Builder} object
     */
	public Builder toBuilder() {
		Builder builder = new Builder()
				.compatibilityFactor(compatibilityFactory)
				.userAgent(userAgent)
				.authManager(authManagers)
	...
	public static class Builder {
		...
		public CoreConfig build() {
			return new CoreConfig(compatibilityFactory, userAgent, authManagers, 
