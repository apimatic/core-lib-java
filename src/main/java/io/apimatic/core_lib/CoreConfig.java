...
public class CoreConfig {
	...
	/**
	 * Builds a new {@link CoreConfig.Builder} object. Creates the instance with the
	 * state of the current state.
	 * 
	 * @return a new {@link CoreConfig.Builder} object
	 */
	public Builder toBuilder() {
		Builder builder = new Builder().compatibilityFactor(compatibilityFactory).userAgent(userAgent)
				.authManager(authManagers).httpCallback(httpCallback).httpClient(httpClient)
				.globalHeaders(globalHeaders).baseUri(baseUri);
		return builder;
