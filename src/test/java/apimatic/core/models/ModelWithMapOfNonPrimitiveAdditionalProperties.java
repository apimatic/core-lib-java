...
public class ModelWithMapOfNonPrimitiveAdditionalProperties {
     ...
     * Default constructor.
     */
    public ModelWithMapOfNonPrimitiveAdditionalProperties() {
    }
     ...
     */
    @JsonAnyGetter
    private Map<String, Map<String, Vehicle>> getAdditionalProperties() {
     ...
     */
    public Map<String, Vehicle> getAdditionalProperty(String key) {
    ...
    public String toString() {
        return "ModelWithMapOfNonPrimitiveAdditionalProperties ["
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder additionalProperty(String name, Map<String, Vehicle> value) {
