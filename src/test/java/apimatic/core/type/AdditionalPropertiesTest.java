...
public class AdditionalPropertiesTest {
    ...
    public void testSimpleAdditionalProperties() throws IOException {
        ModelWithPrimitiveAdditionalProperties simpleModel = new ModelWithPrimitiveAdditionalProperties.Builder(
                "APIMatic").additionalProperty("name", "value").build();

        ModelWithPrimitiveAdditionalProperties actualSimpleModel = CoreHelper
                .deserialize(CoreHelper.serialize(simpleModel), ModelWithPrimitiveAdditionalProperties.class);
        ...
        ModelWithDateTimeAdditionalProperties actualDateTimeModel = CoreHelper
                .deserialize(CoreHelper.serialize(dateTimeModel), ModelWithDateTimeAdditionalProperties.class);
        ...
        // Non-Primitive Case
        ModelWithNonPrimitiveAdditionalProperties nonPrimitiveModel = new ModelWithNonPrimitiveAdditionalProperties.Builder(
        ...
        ModelWithNonPrimitiveAdditionalProperties actualNonPrimitiveModel = CoreHelper
                .deserialize(CoreHelper.serialize(nonPrimitiveModel), ModelWithNonPrimitiveAdditionalProperties.class);
    ...
    public void testArrayAdditionalProperties() throws IOException {
        ModelWithArrayOfPrimitiveAdditionalProperties model = new ModelWithArrayOfPrimitiveAdditionalProperties.Builder(
                "APIMatic").additionalProperty("name", Arrays.asList("value1", "value2")).build();

        List<String> expectedValue = Arrays.asList("value1", "value2");

        ModelWithArrayOfPrimitiveAdditionalProperties actualModel = CoreHelper.deserialize(CoreHelper.serialize(model),
                ModelWithArrayOfPrimitiveAdditionalProperties.class);
        assertEquals(expectedValue, actualModel.getAdditionalProperty("name"));

        // Non-Primitive Case
        ModelWithArrayOfNonPrimitiveAdditionalProperties nonPrimitiveModel = new ModelWithArrayOfNonPrimitiveAdditionalProperties.Builder(
                "APIMatic")
                        .additionalProperty("name",
        ...
        ModelWithArrayOfNonPrimitiveAdditionalProperties actualNonPrimitiveModel = CoreHelper.deserialize(
                CoreHelper.serialize(nonPrimitiveModel), ModelWithArrayOfNonPrimitiveAdditionalProperties.class);
    ...
    public void testArrayOfMapAdditionalProperties() throws IOException {
        ...
        assertEquals(expectedNonPrimitiveModel.get(0).get("key1").toString(),
                actualNonPrimitiveModel.getAdditionalProperty("name").get(0).get("key1").toString());
        assertEquals(expectedNonPrimitiveModel.get(0).get("key2").toString(),
                actualNonPrimitiveModel.getAdditionalProperty("name").get(0).get("key2").toString());
    }

    @Test
    public void test3DArrayAdditionalProperties() throws IOException {
        ModelWith3dArrayOfPrimitiveAdditionalProperties model = new ModelWith3dArrayOfPrimitiveAdditionalProperties.Builder(
                "APIMatic").additionalProperty("name", Arrays.asList(Arrays.asList(Arrays.asList("value1", "value2"))))
                        .build();

        List<List<List<String>>> expectedValue = Arrays.asList(Arrays.asList(Arrays.asList("value1", "value2")));

        ModelWith3dArrayOfPrimitiveAdditionalProperties actualModel = CoreHelper
                .deserialize(CoreHelper.serialize(model), ModelWith3dArrayOfPrimitiveAdditionalProperties.class);
        assertEquals(expectedValue, actualModel.getAdditionalProperty("name"));

        // Non-Primitive Case
        ModelWith3dArrayOfNonPrimitiveAdditionalProperties nonPrimitiveModel = new ModelWith3dArrayOfNonPrimitiveAdditionalProperties.Builder(
                "APIMatic").additionalProperty(
                        "name",
                        Arrays.asList(Arrays.asList(
                                Arrays.asList(new Vehicle.Builder("4").build(), new Vehicle.Builder("4").build()))))
                        .build();

        List<List<List<Vehicle>>> expectedNonPrimitiveModel = Arrays.asList(
                Arrays.asList(Arrays.asList(new Vehicle.Builder("4").build(), new Vehicle.Builder("4").build())));

        ModelWith3dArrayOfNonPrimitiveAdditionalProperties actualNonPrimitiveModel = CoreHelper.deserialize(
                CoreHelper.serialize(nonPrimitiveModel), ModelWith3dArrayOfNonPrimitiveAdditionalProperties.class);
    ...
    public void testTypeCombinatorAdditionalProperties() throws IOException {
        ...
        // Case A
        ModelWithTypeCombinatorAdditionalProperties model = new ModelWithTypeCombinatorAdditionalProperties.Builder(
                "APIMatic").additionalProperty("name", SendScalarParamBody.fromPrecision(Arrays.asList(100.11, 133.00)))
                        .build();

        ModelWithTypeCombinatorAdditionalProperties actualModel = CoreHelper.deserialize(CoreHelper.serialize(model),
                ModelWithTypeCombinatorAdditionalProperties.class);
        List<Double> expectedListValue = Arrays.asList(100.11, 133.00);
